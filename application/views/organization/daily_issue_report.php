	...
	<section>
		<div class="container-fluid ">
			<div class="row">
				...
				<div class="col-md-10 pt-4" style="min-height:120vh;">

					<form class="orgisation-m-frm" action="<?php echo base_url('index.php/organization/print_issue_report') ?>" method="post">
											...
											<table class="table table-striped table-bordered dataTable no-footer" id="myTable" role="grid" aria-describedby="myTable_info">
												<thead>
													<tr role="row">
														...
														<th scope="col" class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Weight: activate to sort column ascending" style="width: 175.859px;">Issue Code</th>
														...
														<th scope="col" class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 215.938px;">Issued By</th>
													</tr>
												</thead>
												<tbody>
