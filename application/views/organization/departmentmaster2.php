	...
	<div class="container-fluid">
		<div class="row">
          ...
          <?php } else {} ?>
				...
				<form class="orgisation-m-frm" action="<?php echo base_url() ?>index.php/organization/department" method="post">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<div class="row">
									<div class="col-md-4"> <span class="text-danger">*</span><label for="Department">Department:</label></div>
									
										<div class="col-md-8"><input type="text" class="form-control" placeholder="Enter Name..." id="Statename" name="dept_name" autocomplete="off" required></div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-md-4"><label for="Statename">Description:</label></div>
										<div class="col-md-8"><input type="text" class="form-control" placeholder="Enter Desc..." id="Statename" name="desc" autocomplete="off" ></div>
							...
							<tbody>
								...
								?>
									...
									<tr class="odd">
										...
										<td>
											<a href="<?php echo base_url('index.php/organization/department_edit/') . $row['id']; ?>"><button type="submit" class="btn btn-primary org-btn rounded">&#9998;</button></a>

											<a href="<?php echo base_url('index.php/organization/department_delete/') . $row['id']; ?>"><button type="submit" class="btn btn-danger org-btn rounded" Style="display:none">Delete</button></a>
											<a href="<?php echo base_url('index.php/organization/department_remove/') . $row['id']; ?>"><button type="submit" class="btn btn-danger org-btn rounded" onclick="return confirm('Are you sure you want to delete this item?');">&#10060;</button></a>
