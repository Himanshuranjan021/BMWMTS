...
?>
	...
	<section>
		...
		<?php } else {} ?>
				 ...
				 <form class="orgisation-m-frm" action="<?php echo base_url('index.php/user/print_waste_collection_report') ?>" method="post">
					<h5>Waste Collection Report</h5>
												...
												<tbody>
													...
													?>
															<tr class="odd">
																...
																<td ><img src="<?php echo base_url()?>barcode/<?php echo $row['barcode'] ?>" alt="" height='100' width='400' /> </td>
