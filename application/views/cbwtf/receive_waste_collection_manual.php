				...
				<div class="col-md-10">
					...
					<div class="adm-cont p-t-40">
						<div class="row">
							...
							<form class="orgisation-m-frm ml-4" method="post" action="<?php echo base_url() ?>index.php/cbwtf/receive_waste_collection_manual" onsubmit="return validation();">

								<h5>Receive Waste Bag Manual</h5>
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (barcode != null) {
						...
						html += '<input type="text" value="' + barcode.weight + '" class="weight_cbwtf" id="weight_cbwtf" value="" name="weight_cbwtf[]" >';
						//html += '<input type="button" class="btn btn-primary get_btn"  value="Get" btn-sm">';
						html += '</td>';
						html += '<td class="remark">';
						html += '<input type="text" value=""  name="reason[]">';
