					...
					success: function(data) {
						...
						if (wt.weight) {
							...
							if (dis >= 0.4) {
								...
								html += '</td>';
								html += '<td><input type="text" value="' + wt.weight + '" name="weight_cbwtf[]" readonly></td>';
								//html+='<td>'+wt.weight+'</td>';
								html += '<td>';
								html += '<input type="text" placeholder="Enter Reason of Weight Descripancy"  name="reason[]" required>';
