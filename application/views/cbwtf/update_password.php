			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<div class="row adm-cont p-t-40">
						...
						<form id="templatemo-preferences-form" class="orgisation-m-frm" accept-charset="utf-8" method="post" action="<?php echo base_url()?>index.php/cbwtf/update_password" name="vehicleform" enctype="multipart/form-data" onsubmit="return checkForm()">
							<h5>CBWTF Change Password</h5>
                      ...
                      <input type="text" class="form-control" placeholder="Old Password" name="old_password" id="oldpassword">
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="text-danger ml-2">	<?php echo form_error('new_password');?></div>
										</div>
									</div>
							...
							<div class="row  p-t-20" style="float: right;">
								...
								<a href="<?php echo base_url()?>index.php/cbwtf/cbwtf_dashboard"> 
