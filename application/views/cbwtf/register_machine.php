            ...
            <div class="row">
                ...
                <div class="col-md-10" style="min-height:100vh;">
                    ...
                    <div class="row adm-cont p-t-40">
                        ...
                        <form class="orgisation-m-frm" action="<?php echo base_url() ?>index.php/cbwtf/link_machine" method="post" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($get_link_data as $row) { ?>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="d-flex">
                                                            <div class="pl-2">
                                                                <a href="<?php echo base_url('index.php/cbwtf/register_machine_delete/') . $row['link_id']; ?>"><button type="submit" class="btn btn-danger org-btn rounded" onclick="return confirm('Are you sure you want to delete this item?');">&#10060;</button></a>
                                                            </div>
...
<script>
    ...
    $('#machine_no').on('change', function() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>index.php/cbwtf/machine_ajax',
            data: {
                [csrfName]: csrfHash,
                'mc_no': scan
            },
