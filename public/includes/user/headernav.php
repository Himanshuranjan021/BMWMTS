...
<div class="container-fluid">
   ...
   <div class="row">
     ...
     <nav class="navbar navbar-expand-md navbar-dark bg-dark sidebarNavigation" data-sidebarClass="navbar-dark bg-dark">        
            ...
            <ul class="nav navbar-nav nav-flex-icons ml-auto adm">
                <li class="nav-item dropdown adm-lg">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="<?php echo site_url('index.php/user/logout'); ?>">Log Out</a>
        ...
        <div class="text-primary"> <?php  $org =$this->session->userdata('bmw_org_master_name'); 
        $user =$this->session->userdata('bmw_hcf_user');
        echo $user." , ". $org; ?>
        </div>
    </nav>
     </div>
